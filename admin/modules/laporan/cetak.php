...
<html xmlns="http://www.w3.org/1999/xhtml"> <!-- Bagian halaman HTML yang akan konvert -->
    ...
    <body>
        <div id="title">
            PT MULTI EKSPRES TRANSINDO
        </div>

        <div id="title-alamat">
            Alamat: Jalan Ridwan Rais No. 23C, Tanjung Baru, Bandar Lampung
        </div>
        
        <div style="margin:-50px 0 0 200px">
            <img src="../../assets/img/transindo.jpg" height="50">
        </div>
        ...
        <div id="isi">
            ...
            <div id="footer-tanggal">
                Bandar Lampung, <?php echo tgl_eng_to_ind("$hari_ini"); ?> <br><br><br><br><br>
                PT MULTI EKSPRES TRANSINDO
            </div>
        </div>
    </body>
