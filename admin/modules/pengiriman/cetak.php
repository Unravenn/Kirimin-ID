...
<html xmlns="http://www.w3.org/1999/xhtml"> <!-- Bagian halaman HTML yang akan konvert -->
    ...
    <body>
        ...
        <table border="0.2">
            <tr>
                <td style="border-right:none;text-align: center" rowspan="3"><img src="../../assets/img/logokurir2.png" width="70"></td>
                <td style="border-left:none" colspan="3" rowspan="3">
                    <span style="font-size:18px"><strong>PT Merpati Express Logistik</strong></span> <span style="color:#fff">....</span> <br>
                    <span style="font-size:11px">Alamat : Jalan Raya Cijulang <br> Kabupaten Pangandaran 46394, Indonesia <br>
                    Telp. +62 85323251840 </span>
                </td>
                <td height="20" align="center" colspan="2"><strong>BUKTI TANDA TERIMA PENGIRIMAN BARANG</strong></td>
            </tr>

            <tr>
                <td height="20" align="center"><strong>PANGANDARAN</strong></td>
            ...
            <tr>
                <td style="padding-left:10px;" colspan="4" rowspan="3">
                    PENERIMA : <?php echo $penerima; ?><br>
                    ALAMAT : <?php echo $alamat_penerima; ?>
                </td>
                <td height="20" align="center">NAMA BARANG</td>
                <td style="padding-left:3px;" height="20" align="center"><span style="color:#fff">..</span>QTY<span style="color:#fff">..</span></td>
            </tr>
            ...
            <tr>
                ...
                <td align="center" rowspan="4"><img src="../../assets/img/logokurir2.png" width="50"></td>
            </tr>
            ...
            <tr>
                <td height="20" colspan="6" align="center">CATATAN : ALAMAT PENERIMA ADALAH DIDALAM KOTA ATAU DALAM BATAS WILAYAH PENGIRIMAN BARANG</td>
            </tr>
